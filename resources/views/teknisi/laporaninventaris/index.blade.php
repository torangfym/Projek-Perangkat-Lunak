                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div
                                                        ...
                                                        <a href="{{ route('edit.laporaninventaris', ['idlaporaninventaris' => $items->idlaporaninventaris]) }}" class="btn btn-warning">
    ...
    <div id="myModal" class="modal fade">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" id="myForm" action="{{ route('laporaninventaris.post') }}" enctype="multipart/form-data" novalidate>
                        @csrf
