            ...
            <section class="content">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Dashboard Kepalalab</h3>
                        ...
                        <div class="row">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="position-relative mb-4">
                                            <canvas id="barang-chart" height="200"></canvas>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4">
                                <div class="card">
                                    <div class="card-header border-0">
                                        <div class="d-flex justify-content-between">
                                            <h3 class="card-title">Total Peminjam</h3>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <div class="position-relative mb-4">
                                            <canvas id="peminjam-chart" height="200"></canvas>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <script>
                    document.addEventListener("DOMContentLoaded", function() {
                        ...
                        drawChart('barang-chart', 'Total Barang', {{ $barangdata ?? 0 }});
                        drawChart('peminjam-chart', 'Total Peminjam', {{ $peminjamdata ?? 0 }});
                        drawChart('laporan-chart', 'Total Laporan', {{ $laporandata ?? 0 }});
                    });
