    ...
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="{{ route('lokasi.kepalalab') }}" class="nav-link">Daftar Lokasi</a>
                </li>
            </ul>
                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            <a href="{{ route('lokasi.staff') }}"
                                class="nav-link {{ Request::segment(1) === 'kepalalab' && Request::segment(2) === 'lokasibarang' ? 'active' : '' }}">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="box-body">
                            ...
                            @if (isset($data_lokasibarang[0]))
                                <a href="{{ route('barangcetakruangan.kepalalab', ['idlokasi' => $data_lokasibarang[0]->idlokasi, 'idlokasibarang' => $data_lokasibarang[0]->idlokasibarang]) }}"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <form
                            action="{{ route('lokasibarangkepalalab.hapus', ['idlokasibarang' => $item->idlokasibarang]) }}"
    ...
    <div id="myModal" class="modal fade">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" id="myForm" action="{{ route('lokasibarangkepalalab.post') }}"
                        novalidate>
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <select name="idlokasi" id="idlokasi" class="form-control" required readonly>
