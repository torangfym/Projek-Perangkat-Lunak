                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            <a href="{{ route('lokasi.kepalalab') }}"
                                class="nav-link {{ Request::is('kepalalab/lokasi') ? 'active' : '' }}">
                                            ...
                                            <tr>
                                                ...
                                                <td style="display: flex; justify-content: center; align-items: center;">
                                                    <div style="display: flex; gap: 8px;">
                                                        <form method="get" action="{{ route('lokasibarang.kepalalab', ['idlokasi' => $items->idlokasi]) }}">
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="post"
                                action="{{ route('lokasikepalalab.update', ['idlokasi' => $items->idlokasi]) }}" novalidate>
                                @csrf
                                @method('PUT')
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <form action="{{ route('lokasikepalalab.hapus', ['lokasi' => $items->idlokasi]) }}" method="POST"
                                class="inline-block">
                                @csrf
                                @method('DELETE')
    ...
    <div id="myModal" class="modal fade">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" id="myForm" action="{{ route('lokasikepalalab.post') }}" novalidate>
                        @csrf
