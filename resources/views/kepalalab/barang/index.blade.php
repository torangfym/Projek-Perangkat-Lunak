                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div
                                                        ...
                                                        <a href="{{ route('barangdetail.kepalalab', ['idbarang' => $items->idbarang]) }}"
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="post"
                                action="{{ route('barangkepalalab.update', ['idbarang' => $item->idbarang]) }}" novalidate
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <form action="{{ route('barangkepalalab.hapus', ['barang' => $item->idbarang]) }}" method="POST"
                                class="inline-block">
                                @csrf
                                @method('DELETE')
    ...
    <div id="myModal" class="modal fade">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" id="myForm" action="{{ route('barangkepalalab.post') }}"
