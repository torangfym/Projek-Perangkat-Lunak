            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            <a href="{{ route('kategori.kepalalab') }}" class="nav-link {{ Request::is('kepalalab/kategori') ? 'active' : '' }}">
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="post"
                                action="{{ route('kategorikepalalab.update', ['idkategori' => $items->idkategori]) }}"
                                novalidate>
                                @csrf
                                @method('PUT')
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <form action="{{ route('kategorikepalalab.hapus', ['kategori' => $items->idkategori]) }}"
    ...
    <div id="myModal" class="modal fade">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" id="myForm" action="{{ route('kategorikepalalab.post') }}" novalidate>
                        @csrf
