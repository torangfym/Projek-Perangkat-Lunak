            ...
            <section class="content">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Dashboard Staff</h3>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <div class="card">
                                    <div class="card-header border-0">
                                        <div class="d-flex justify-content-between">
                                            <h3 class="card-title">Total Riwayat Peminjaman</h3>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <div class="position-relative mb-4">
                ...
                <script>
                    document.addEventListener("DOMContentLoaded", function () {
                        ...
                        drawBarChart('barang-chart', 'Total Barang', {{ $barangdata ?? 0 }});
                        drawBarChart('peminjam-chart', 'Total Riwayat Peminjaman', {{ $Riwayatdata ?? 0 }});
