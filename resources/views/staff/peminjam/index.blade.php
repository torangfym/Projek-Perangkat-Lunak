                    ...
                    <div class="card-body">
                        ...
                        <div class="box-body">
                            <div class="container">
                                ...
                                <a href="{{ route ('peminjamcetakpdf.staff')}}" class="btn btn-primary">
                            ...
                            <form method="post"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="edit-NPM" name="NPM"
                                        value="{{ $item->NPM }}" class="form-control" required>
                                </div>
        ...
        function confirmSelesai() {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    form.action = '{{ route("peminjaman.selesai", ["idpeminjam" => isset($items) ? $items->idpeminjam : null]) }}';
