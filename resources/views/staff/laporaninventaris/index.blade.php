                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            <a href="{{ route('laporaninventaris.staff') }}"
                                class="nav-link {{ Request::is('staff/laporaninventaris') ? 'active' : '' }}">
            ...
            <section class="content">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Daftar Laporan Inventaris</h3>
                            ...
                            <div class="container">
                                <button style="margin-bottom: 20px; width: 150px; height: 40px; border-radius: 20px;"
                                    data-toggle="modal" data-target="#myModal" class="btn btn-info"><span
                                        class="glyphicon glyphicon-plus"></span>Tambah Laporan</button>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div
                                                        ...
                                                        <a href="{{ route('edit.laporaninventarisstaff', ['idlaporaninventaris' => $items->idlaporaninventaris]) }}" class="btn btn-warning">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <form
                            action="{{ route('laporaninventarisstaff.hapus', ['id' => $item->idlaporaninventaris]) }}"
    ...
    <div id="myModal" class="modal fade">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" id="myForm" action="{{ route('laporaninventarisstaff.post') }}" enctype="multipart/form-data" novalidate>
                        @csrf
...
<script>
    document.getElementById('myForm').addEventListener('submit', function(event) {
        ...
        var asalTeknisi = document.getElementById('edit-asal').value; // Assuming the ID is 'edit-asal'
        var kondisiBaru = document.getElementById('kondisiterbaru').value;
        var detail = document.getElementById('edit-detail').value;
        var tanggalLaporan = document.getElementById('edit-created-at').value;

        if (!selectedBarang || !asalTeknisi || !kondisiBaru || !detail || !tanggalLaporan) {
            Swal.fire({
                icon: 'error',
                title: 'Oops...',
