                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            <a href="{{ route('laporaninventaris.staff') }}"
                                class="nav-link {{ Request::is('staff/laporaninventaris/edit/*') ? 'active' : '' }}">
                    ...
                    <div class="card-body">
                        ...
                        <div class="box-body">
                            <div class="container">
                                ...
                                <form method="post"
                                action="{{ route('laporaninventarisstaff.update', ['idlaporaninventaris' => $laporaninventaris->idlaporaninventaris]) }}"
                                novalidate enctype="multipart/form-data">
                                        ...
                                        <div class="modal-footer">
                                            <a href="{{ route('laporaninventaris.staff') }}" class="btn btn-warning" data-dismiss="modal">Batal</a>
